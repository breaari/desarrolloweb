...
export const Contact = () => {
    ...
    return (
        ...
        <div className="relative blue-rounded-tl laputaquetepario min-h-screen max-w-screen bg-azuloscuro flex flex-row justify-center items-center mq980:flex-col overflow-hidden">
          <div className="relative bg-white w-[50%] text-5xl text-azuloscuro font-extrabold text-center flex flex-col justify-center items-center px-10 py-10 mq980:w-full mq980:px-5 mq980:text-4xl mq980:pt-16 mq980:pb-5">
